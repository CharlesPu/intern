...
//	int ret6 = pthread_create(&th[5],&attr[5],Task::ClientSend,(void*)&c);//等待客户端数据
	...
	int ret1 = pthread_create(&th[0],&attr[0],Task::ClientReceive,(void*)&can_eth_para1);//等待客户端数据
	int ret2 = pthread_create(&th[1],&attr[1],Task::CanSend,(void*)&can3);//等待客户端数据
	int ret3 = pthread_create(&th[2],&attr[2],Task::CanReceive,(void*)&can_eth_para2);//等待客户端数据
	int ret4 = pthread_create(&th[3],&attr[3],Task::ClientSend,(void*)&c);//等待客户端数据
