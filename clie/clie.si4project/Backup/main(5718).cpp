...
int main(int argc,char* args[])
{
	...
	can_eth_para1._another_can=&can3;
	can_eth_para1._client=&c;
	CanEthPara can_eth_para2;
	can_eth_para2._can=&can3;
	can_eth_para2._another_can=&can2;
...
//	int ret6 = pthread_create(&th[5],&attr[5],Task::ServerSend,(void*)&s);//等待客户端数据
	int ret1 = pthread_create(&th[0],&attr[0],Task::CanSend,(void*)&can2);//等待客户端数据
